      ...
      <div className="flex flex-col grow py-2 my-4 bg-white lg:mx-4 ">
        ...
        <div className="flex place-content-center">
          <a href="https://www.facebook.com/TheCodeYogi">
            <div className="flex items-center justify-center w-12 h-12 rotate-45 bg-red-200 border border-4 border-black hover:bg-red-600">
              <img
          ...
          <a href="https://www.instagram.com/thecodeyogi/">
            <div className="flex items-center justify-center w-12 h-12 rotate-45 bg-green-200 border border-4 border-black hover:bg-green-600">
              <img
          ...
          <a href="https://in.linkedin.com/">
            <div className="flex items-center justify-center w-12 h-12 rotate-45 bg-blue-200 border border-4 border-black hover:bg-blue-600">
              <img
